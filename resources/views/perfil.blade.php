            ...
            <div class="card">
              <div class="card-body pt-3">
                ...
                <ul class="nav nav-tabs nav-tabs-bordered">
                  ...
                  <li class="nav-item">
                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Informações do Usuário</button>
                  </li>
                    ...
                    <form>
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <img src="{{ asset('assets/img/'.Auth::user()->profile_image)}}" style="width: 350px;height:350px;" alt="Profile">
                          <div class="pt-2">
